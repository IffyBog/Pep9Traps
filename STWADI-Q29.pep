...
SP_PCB:  .EQUATE 9
IR_PCB:  .EQUATE 11
opcode26:LDWA    0x0002,i    ;Set IR to be indirect 
         STBA    IR_PCB,s    ;Store IR
         LDWA    PC_PCB,s    ;PC into Acc
         ADDA    2,i         ;Increment PC by 2
         STWA    PC_PCB,s    ;Store the new PC
         CALL    setAddr     ;Create the appropiate memory location to accesss
         LDWX    opAddr,n    ;Set X to that memory location
         LDWA    A_PCB,s     ;Load Acc
         STWA    0,x         ;Write value of Acc to that memory location
         RET
;
;******* Opcode 0x27
